 ...
 *
 * V4 - Frentes, equipes, programação diária, diário de obra e dashboard
...
const DB_SCHEMA = Object.freeze({
  ...
  FRENTES: [
    'ID_FRENTE','ID_OBRA','CODIGO','NOME','ORDEM','ATIVA','CRIADO_EM','ATUALIZADO_EM'
  ],

  EQUIPES: [
    'ID_EQUIPE','ID_ORGANIZACAO','CODIGO','NOME','COR','ATIVA','CRIADO_EM','ATUALIZADO_EM'
  ],
  ...
  ATIVIDADES: [
    'ID_ATIVIDADE','ID_OBRA','ID_WBS','ID_FRENTE','CODIGO','NOME','ID_TIPO_ATIVIDADE',
  ...
  ATIVIDADE_EQUIPES: [
    'ID_ATIVIDADE_EQUIPE','ID_OBRA','ID_ATIVIDADE','ID_EQUIPE','ATIVA','CRIADO_EM','ATUALIZADO_EM'
  ],

  PROGRAMACAO_DIARIA: [
    'ID_PROGRAMACAO','ID_OBRA','ID_ATIVIDADE','DATA','PERCENTUAL_PLANEJADO',
    'OBSERVACAO','ATIVA','CRIADO_EM','ATUALIZADO_EM'
  ],

  PROGRAMACAO_EQUIPE: [
    'ID_PROGRAMACAO_EQUIPE','ID_PROGRAMACAO','ID_OBRA','ID_ATIVIDADE','ID_EQUIPE',
    'QUANTIDADE_PESSOAS','ATIVA','CRIADO_EM','ATUALIZADO_EM'
  ],
  ...
  EXECUCAO_EQUIPE: [
    'ID_EXECUCAO_EQUIPE','ID_EXECUCAO','ID_OBRA','ID_ATIVIDADE','ID_EQUIPE',
